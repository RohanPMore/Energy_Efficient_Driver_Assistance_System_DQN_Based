...
# Training loop
def train_agent(env, agent, track_data, episodes=1000, epsilon_start=1.0, epsilon_end=0.01, epsilon_decay=0.995, target_update=100):
    epsilon = epsilon_start
    total_rewards = []
    max_steps = len(track_data['v_max'])  # Set max_steps based on track_data['v_max']
