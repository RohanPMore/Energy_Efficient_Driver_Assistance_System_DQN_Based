...
class EVEnv(gym.Env):
    ...
    def reset(self): ##First Done Mark
        ...
        self.aplha_step__rad_per_s = self.road_angle__rad[0]
        self.current_step = 0
        self.done = False
    ...
    def get_legal_actions(self): ##First Done Mark
        ...
        self._update_observation_space()
        self.aplha_step__rad_per_s = self.road_angle__rad[self.current_step]
        legal_actions = []
    ...
    def step(self, action): ##First Done Mark
        ...
        fuel_consumed = self.fcnEV_instance.rewards_energy_efficiency_func()      
        self.total_fuel_consumption += fuel_consumed # Update the total fuel consumption
        self.reward = self.get_reward(fuel_consumed, self.total_fuel_consumption)
